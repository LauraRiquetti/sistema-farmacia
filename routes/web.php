...
use App\Http\Controllers\CarrinhoController; // <-- Subi a importação para cá!

// Rotas de produtos (Corrigido: Adicionado os nomes nas rotas)
...
Route::get('/home', [HomeController::class, 'index']); // Removi o name duplicado para evitar conflitos
...
// NOVA: Rota de Finalizar Compra (Protegida pelo Login)
